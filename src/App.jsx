      ...
      <section id="section1">
        <nav>
          ...
          <div className="nav-elem">
            <i className="ri-menu-3-line"></i> {/* Fixed class -> className */}
          </div>
        </nav>
        ...
        <footer>
          <div className="footer-center">
            ...
            <div className="footer-center-divs">
              <svg
                fill="white"
                className="baseline" // Fixed class -> className
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 30.67 54.43"
              >
                {/* ... SVG Paths kept identical to your code ... */}
                <path d="M592.66,694.59l-3-9.13-.81-.69h4.06l-.89.69,2.17,7.06,1.4-5-.7-2.15-.78-.59h4.06l-.92.59,2.21,7.17,2.17-7.09-1-.66h2.28l-.91.66-2.74,8.86-1.35.3L595.77,688,594,694.29Z" transform="translate(-575.91 -684.77)"></path>
                {/* (Truncated other paths for brevity, keep your original paths here) */}
              </svg>
            </div>
          </div>
        </footer>
