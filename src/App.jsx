      ...
      <section id="section4">
        ...
        <footer>
          <div className="footer-center">
            <div className="footer-center-divs"><h1>Chicago</h1></div>
            <div className="footer-center-divs"><h1>Amsterdam</h1></div>
            <div className="footer-center-divs"><h1>Paris</h1></div>
